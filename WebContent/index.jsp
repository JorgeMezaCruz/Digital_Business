                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    ...
                                    <span class="desc">Clientes atendidos</span>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3" >
                                <div class="statistic__item" style="background-color:#AED6F1;">
                                    <h2 class="number">-->CLICK</h2>
                                    <span class="desc">Carrito de Compras</span>
                                    <div class="icon" >
                                        <a href="boleta.jsp">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    ...
                                    <span class="desc">Venta de la semana</span>
                                    <div class="icon">
                                        <i class="zmdi zmdi-shopping-cart"></i>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    ...
                                    <span class="desc">Venta mensual</span>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    ...
                                    <span class="desc">Venta Semanal</span>
                                    <div class="icon">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                              <!-- TASK PROGRESS-->
                                <div class="au-card task-progress">
                                    <h3 class="title-3">Progreso de ventas por marca</h3>
                                    <div class="au-skill-container">
                                        <div class="au-progress">
                                            <span class="au-progress__title">Samsumg</span>
                                        ...
                                        <div class="au-progress">
                                            <span class="au-progress__title">Xiami</span>
                                            <div class="au-progress__bar">
                                        ...
                                        <div class="au-progress">
                                            <span class="au-progress__title">Motorola</span>
                                            <div class="au-progress__bar">
                                        ...
                                        <div class="au-progress">
                                            <span class="au-progress__title">Huawei</span>
                                            <div class="au-progress__bar">
                            ...
                            <div class="au-card chart-percent-card">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 tm-b-5">Porcentaje compras y ventas %</h3>
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="percent-chart"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                                                    <canvas id="percent-chart" height="280" width="259" class="chartjs-render-monitor" style="display: block; width: 259px; height: 280px;"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
